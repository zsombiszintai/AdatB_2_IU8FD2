...
-- FK
CONSTRAINT fk_user_follow_follower_id FOREIGN KEY (follower_id) REFERENCES cityscape_users(id),
CONSTRAINT fk_user_follow_followed_id FOREIGN KEY (followed_id) REFERENCES cityscape_users(id),
